...
# brief period where data may be pickled in python3 (during deploy, or if we
# rollback), where if we did not declare the version, would be in format that
# python 2's pickle COULD NOT decode.
#
